...
import { addToCartProduct, getCartProducts } from "../features/user/userSlice";
...
const SingleProduct = () => {
  ...
  useEffect(() => {
    for (let item = 0; item < cartProducts?.length; item++) {
      if (productId === cartProducts[item].productId?._id) {
        setAlredyAdded(true);
      }
    }
  ...
  const handleAddtoCart = (productData) => {
    if (color === null) {
      toast.info("Please choose a color");
    } else {
      dispatch(
        addToCartProduct({
            ...
            <div className="main-product-details">
              ...
              <div className=" py-3">
                <div className="d-flex gap-10 align-items-center my-2">
                  ...
                  <p className="product-data">fdeb</p>
                </div>
                <div className="d-flex gap-10 align-items-center my-2">
                ...
                <div className="d-flex align-items-center gap-15 flex-row mt-2 mb-3">
                  ...
                  <div className={alredyAdded ? "ms-0" : "d-flex align-items-center gap-30 ms-5"}>
                    <button
                      className="button border-0"
                      // data-bs-toggle="modal"
                      // data-bs-target="#staticBackdrop"
                      type="button"
                      onClick={() => alredyAdded ? navigate("/cart") : handleAddtoCart(product)}
                    >
